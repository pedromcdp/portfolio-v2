...
function ProjectCard({ project }: { project: IProject }) {
  ...
  return (
    <article className="flex min-h-72 flex-col lg:flex-row  items-center lg:items-stretch mt-4 font-medium dark:border border-zinc-600 shadow-lg py-4 px-6 rounded-lg h-auto gap-4 transition-all durantion-150 ease-in-out">
